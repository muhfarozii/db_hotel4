...
if (isset($_POST['check_in'])) {
    ...
    $nama_kamar = "modern Room"; // Nilai otomatis untuk nama kamar
    $harga = 480000.00; // Nilai otomatis untuk harga
...
<body>
    <div class="container">
            ...
            <div id="imageCarousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="https://mel365.com/wp-content/uploads/2018/11/Hotel-Valentina.jpg" alt="Gambar 1">
                    </div>
        ...
        <!-- Content Section -->
        <div class="content">
            <h2 class="nama-kamar">Modern Room</h2>
            <p class="deskripsi-kamar">
            Temukan kenyamanan dan gaya kontemporer di Modern Room kami. Kamar ini dirancang dengan sentuhan modern yang elegan, menampilkan interior minimalis dan fasilitas canggih seperti TV layar datar, AC, Wi-Fi cepat, dan kamar mandi pribadi dengan desain modern. Cocok untuk tamu yang menghargai kesederhanaan dan fungsionalitas, kamar ini menawarkan suasana santai yang sempurna untuk bersantai setelah seharian beraktivitas. Nikmati pengalaman menginap yang stylish dan nyaman di kamar kami yang dirancang untuk memenuhi kebutuhan Anda.
            </p>
            ...
            <h4 class="price-room">Rp. 480.000</h4>
            <ul class="list-group">
