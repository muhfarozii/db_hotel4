...
if (isset($_POST['check_in'])) {
    ...
    $nama_kamar = "Superior Room"; // Nilai otomatis untuk nama kamar
    $harga = 850000.00; // Nilai otomatis untuk harga
...
<body>
    <div class="container">
            ...
            <div id="imageCarousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="https://assets-global.website-files.com/65328f6a71f27b2c877f7058/654df8e8f443499d9c627305_654cac0ff66afae5e30bbd02_5fa915848e21a18aa28674e8_dark%2520charcoal.webp" alt="Gambar 1">
                    </div>
        ...
        <div class="content">
            <h2>Superior Room</h2>
            <p>Nikmati keistimewaan di Romance Room kami yang dirancang dengan romantis dan elegan. Dilengkapi dengan tempat tidur premium, Wi-Fi berkecepatan tinggi, TV layar datar, dan kamar mandi pribadi mewah, kamar ini menawarkan suasana hangat dan tenang untuk pengalaman menginap yang sempurna.</p>
