...
if (isset($_POST['check_in'])) {
    ...
    $nama_kamar = "Romance Room"; // Nilai otomatis untuk nama kamar
...
<body>
    <div class="container">
            ...
            <div id="imageCarousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="https://ds393qgzrxwzn.cloudfront.net/resize/m720x480/cat1/img/images/0/OewAHgrGv0.jpg" alt="Gambar 1">
                    </div>
        ...
        <div class="content">
            <h2>Romance Room</h2>
            <p>Nikmati kehangatan istimewa di Romance Room kami yang dirancang dengan romantis dan elegan. Dilengkapi dengan tempat tidur premium, Wi-Fi berkecepatan tinggi, TV layar datar, dan kamar mandi pribadi mewah, kamar ini menawarkan suasana hangat dan tenang untuk pengalaman menginap yang sempurna.</p>
