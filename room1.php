...
if (isset($_POST['check_in'])) {
    ...
    $nama_kamar = "Deluxe Room"; // Nilai otomatis untuk nama kamar
    $harga = 800000.00; // Nilai otomatis untuk harga
...
<body>
    <div class="container">
            ...
            <div id="imageCarousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="https://th.bing.com/th/id/OIP.vaALJtnElHA1PUVwbj6ZDQHaE8?w=900&h=600&rs=1&pid=ImgDetMain" alt="Gambar 1">
                    </div>
        ...
        <div class="content">
            <h2>Deluxe Room</h2>
            <p>Nikmati kenyamanan istimewa di Deluxe Room kami yang dirancang dengan gaya modern dan elegan. Dilengkapi dengan tempat tidur premium, Wi-Fi berkecepatan tinggi, TV layar datar, dan kamar mandi pribadi mewah, kamar ini menawarkan suasana hangat dan tenang untuk pengalaman menginap yang sempurna.</p>
