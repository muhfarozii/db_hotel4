...
if (isset($_POST['check_in'])) {
    ...
    $nama_kamar = "presidential Room"; // Nilai otomatis untuk nama kamar
    $harga = 450000.00; // Nilai otomatis untuk harga
...
<body>
    <div class="container">
            ...
            <div id="imageCarousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="https://images.solopos.com/2019/12/Ilustrasi-kamar-hotel.-Freepik.jpg" alt="Gambar 1">
                    </div>
        ...
        <!-- Content Section -->
        <div class="content">
            <h2 class="nama-kamar">Presidential Room</h2>
            <p class="deskripsi-kamar">
            Rasakan kemewahan dan keistimewaan di Presidential Room kami, yang dirancang untuk tamu yang menginginkan pengalaman menginap kelas dunia. Kamar ini menawarkan ruang yang luas dan elegan, dilengkapi dengan area tidur mewah, ruang tamu privat, ruang makan pribadi, serta kamar mandi mewah dengan fasilitas spa. Nikmati fasilitas eksklusif seperti TV layar datar ultra-besar, sistem hiburan canggih, mini-bar premium, dan akses ke layanan butler 24 jam. Cocok untuk tamu VIP, eksekutif, atau siapa pun yang mencari akomodasi dengan sentuhan kemewahan dan privasi yang tak tertandingi. Presidential Room adalah puncak dari kenyamanan dan keanggunan.
            </p>
            ...
            <h4 class="price-room">Rp. 450.000</h4>
            <ul class="list-group">
